...
var _typeof =
    "function" == typeof Symbol && "symbol" == typeof Symbol.iterator
        ...
        : function(i) {
              return i && "function" == typeof Symbol && i.constructor === Symbol && i !== Symbol.prototype
                  ? "symbol"
                  : typeof i;
          };
function _defineProperty(i, e, t) {
    return (
        e in i ? Object.defineProperty(i, e, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : (i[e] = t),
        i
    );
}
layui.define(["layer", "laytpl", "utils", "lodash"], function(i) {
    ...
    (o.prototype.defaults = {
        ...
        (o.prototype.render = function(i) {
            ...
            e.extend(!0, d, i);
            var o = d;
            if (!a.oneOf(o.direction, ["left", "right"]))
                return a.error('Sidebar error: [direction] property error,Only "left" or "right" .'), t;
    ...
    var c = {
        renderHTML: function(i, n) {
            var o = e(i.elem);
            void 0 === o.attr("kit-sidebar-target") &&
                t(r).render(n, function(t) {
                    i.shade && (t = t + '<div class="kit-shade" kit-shade="' + n.id + '"></div>'),
                        d.append(t),
                    ...
                    o.attr("data-toggle", "off"),
                        o.attr("kit-sidebar-target", "true"),
                        o.on("click", function() {
                            switch (e(this).data("toggle")) {
                                case "on":
                                    r.animate(_defineProperty({}, i.direction, "-" + i.width)),
                                        l.hide(),
                                        e(this).data("toggle", "off");

                                    break;
                                case "off":
                                    r.animate(_defineProperty({}, i.direction, "0px")),
                                        l.show(),
