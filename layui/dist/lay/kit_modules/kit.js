            ...
            t.on("click", function() {
                ...
                switch (t.attr("data-toggle")) {
                    case "on":
                        a.animate({ width: "0px" }),
                            s.animate({ left: "0" }),
                            e.animate({ "margin-left": "0" }),
                            l.animate({ left: "0" }),
                            i(this).attr("data-toggle", "off"),
                            t.find("i.layui-icon").html("&#xe65b;");
                        t.parent()
                            .parent()
                            .parent()
                        ...
                        break;
                    case "off":
                        a.animate({ width: "270px" }),
                            s.animate({ left: "270px" }),
                            l.animate({ left: "270px" }),
                            e.animate({ "margin-left": "270px" }),
                            i(this).attr("data-toggle", "on"),
                            t.find("i.layui-icon").html("&#xe65a;");
                        t.parent()
                            .parent()
                            .parent()
                            .animate({ "margin-left": "270px" });
                }
            }),
