...
layui.define(["jquery", "utils", "axios"], function(e) {
    ...
    (o.prototype.set = function(e) {
        ...
        (o.prototype.render = function() {
            ...
            if (i.dynamicRender)
                if (i.data.length > 0)
                    r.setItem(i.cacheKey, t),
                        u.renderHTML(i.elem, i.data, function() {
                            e.bind();
                        });
                else {
                    var n = !1;
                    if (i.cached) {
                        ...
                        null !== t &&
                            void 0 !== t &&
                            ((n = !0),
                            u.renderHTML(i.elem, t, function() {
                                e.bind();
                            }));
                    }
                    n ||
                        u.loadData(i.remote, function(n) {
                            r.setItem(i.cacheKey, n),
                                u.renderHTML(i.elem, n, function() {
                                    e.bind();
                                });
                        });
                }
                ...
                i(l)
                    ...
                    .each(function() {
                        ...
                        ("" !== o && void 0 !== o) || ((o = n.randomCode()), t.attr("lay-id", o)),
                            a.off("click").on("click", function(u) {
                                if (
                                    (layui.stope(u),
                                    r
                                        ? (t.hasClass("layui-show")
                                              ? t.removeClass("layui-show")
                                              : t.addClass("layui-show"),
                                          e.onlyOne && t.attr("lay-one") && t.siblings().removeClass("layui-show"))
                                        : (i(l)
                                              .find(s)
                                              .removeClass("layui-this"),
                                          t.addClass("layui-this")),
                                    n.isFunction(e.onClicked) &&
                                        e.onClicked({ elem: t, hasChild: r, data: { href: a.attr("href"), layid: o } }),
                                    !e.isJump)
                                )
                                    return !1;
                            });
    ...
    var u = {
        ...
        recursion: function(e, i, n) {
            ...
            t.forEach(i, function(e, i) {
                ...
                r.length > 0 &&
                    t.forEach(r, function(i) {
                        var n = i.open ? "layui-show" : "";
                        e.push('<li class="kit-menu-item ' + n + '">');
                        var r = t.isEmpty(i.path) ? "javascript:;" : i.path;
                        i.blank ? e.push('<a href="' + r + '" target="_blank">') : e.push('<a href="' + r + '">'),
                            e.push('<i class="layui-icon">' + i.icon + "</i> "),
                            e.push("<span>" + i.title + "</span>"),
                            e.push("</a>");
                        var o = i.children;
                        void 0 !== o &&
                            null !== o &&
                            o.length > 0 &&
                            (e.push('<ul class="kit-menu-child kit-menu-child layui-anim layui-anim-upbit">'),
                            a.recursion(e, o, i.id),
                            e.push("</ul>")),
                            e.push("</li>");
                    });
        },
