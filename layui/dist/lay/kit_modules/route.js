...
layui.define(["utils", "jquery", "lodash", "nprogress", "layer"], function(e) {
    var i = layui.utils,
        ...
        l = void 0,
        d = function() {
            (this.config = { name: "KITADMINROUTE", routerViewId: void 0, beforeRender: void 0, routes: [] }),
                (this.version = "1.2.1");
        };
    (d.prototype.set = function(e) {
        ...
        (d.prototype.render = function(e, t, o) {
            ...
            if (t && t.length > 0) d = t;
                ...
                f.length > 0 &&
                    (f.parent().append('<div id="' + v + '"></div>'), f.remove(), (d = r("#" + v)), (l = d));
            }
            void 0 === d && (d = l);
            var h = n.getRoute(e);
            function p() {
            ...
            return (
                void 0 !== h
                    ? ("function" == typeof a.beforeRender && (h = a.beforeRender(h)),
                      h.iframe
                          ? (d.html(
                                '<iframe src="' + h.component + '" data-id="' + v + '" style="height: 780px;"></iframe>'
                            ),
                            u
                                .on("resize", function() {
