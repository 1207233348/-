...
layui.define(mods, function(e) {
    ...
    var u = {
            ...
            var t = this,
                a = {
                    ...
                    routes: [
                        ...
                        { path: "/", component: "../view/home-page.html", name: "主页" },
                        {
                            path: "/view/pre-approved",
                            component: "../view/pre-approved/pre-approved.html",
                            name: "预审批报销"
                        },
                        ...
                        {
                            path: "/layui/layer",
                            component: "../layui/dist/views/layui/layer.html",
                            name: "layer"
                        },
                        ...
                        { path: "/user/table", component: "../layui/dist//views/table/teble.html", name: "Table" },
                        { path: "/user/table2", component: "/views/table/teble2.html", name: "数据表格2" },
            ...
            return (
                "TABS" === e.loadType &&
                    (a.onChanged = function() {
                        i.existsByPath(location.hash)
                            ? i.switchByPath(location.hash)
        ...
        tabsInit: function() {
            i.set({ onChanged: function(e) {} }).render(function(e) {
                e.isIndex && n.render("#/");
            });
        }
    };
